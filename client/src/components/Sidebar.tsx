      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        <div className="sidebar-header">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            <button className="sidebar-btn" aria-label="Toggle theme" onClick={onToggleTheme}>
              {theme === 'dark' ? (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="sidebar-conversations">
          {isPaired ? (
            ...
            <div className="conversation-empty" style={{ padding: '0 1rem', color: 'var(--text-muted)', fontSize: '0.875rem' }}>
              Not paired yet
            </div>
          )}
        </div>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            ...
            <div className="user-info" onClick={onOpenSettings} style={{ cursor: 'pointer' }}>
              <span className="user-name">{displayName}</span>
              {profile?.username && <span className="user-handle" style={{ fontSize: '0.75rem', color: 'var(--wibby-text-muted)' }}>@{profile.username}</span>}
            </div>
            <button
